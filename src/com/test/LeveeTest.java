...
public class LeveeTest {
	...
	public void testGetLaDate() {
		...
		// à faire sur les 2 objets pour v�rifier les affectations 
		// dans les 2  constructeurs
		// récupèration date de la levèe l1 avec manipulation de date
		...
		assertEquals(day, 15);
		// date de levee l2 avec dateFormat
	...
	public void testSetLaDate() {
		...
		try
		{
			// instanciation date de levée au format fran�ais
